...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F4F9F8] font-sans selection:bg-[#00B4C1]/20 selection:text-[#00B4C1]">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-50 h-screen transition-all duration-500 cubic-bezier(0.4, 0, 0.2, 1) ${
                    ...
                    {visibleItems.map((item) => {
                      ...
                      return (
                        <Link
                          ...
                          className={`flex items-center group relative px-4 py-3 rounded-xl transition-all duration-300 ${
                            isActive
